...
class ResidentsControllerTest < ActionController::TestCase
  ...
  test "should create resident" do
    assert_difference('Resident.count') do
      post :create, resident: { city: @resident.city, name: @resident.name, state: @resident.state, street: @resident.street, zip_code: @resident.zip_code }
    end
  ...
  test "should update resident" do
    put :update, id: @resident, resident: { city: @resident.city, name: @resident.name, state: @resident.state, street: @resident.street, zip_code: @resident.zip_code }
    assert_redirected_to resident_path(assigns(:resident))
  end
